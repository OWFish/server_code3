...
public:
	...
	bool GetRankList(int rank_type, std::vector<int>& ret,int retsize);

	bool GetRankListWithScore(int rank_type, std::vector<int>& ret, int retsize);
...
private:
	...
	DynamicRankingMgr *dynamic_rank_mgr_; //实时更
};
