...
namespace Protocol {
	...
	enum BaseCmd { // CMD_Base
		...
		sBaseCmd_BattleComparison = 38, //战力对比数据
		...
		cBaseCmd_GetActorInfoByName = 17,
	...
	enum FubenCmd { // CMD_Fuben,
		...
		sFubenCmd_SendFastBattleData = 43,   //快速战斗数据
		sFubenCmd_SendFastBattleAwards = 44, //快速战斗奖励
		...
		cFubenCmd_GetFastBattleData = 43,   //快速战斗数据
		cFubenCmd_GetFastBattleAwards = 44, //快速战斗领奖
	};
	...
	enum SkillCmd {
		...
		sSkillCmd_SendSkillExp = 14,
		sSkillCmd_UpdateChoisList = 15,
	...
	enum EquipCmd {
		...
		sEquipCmd_SendLeiTingLevelUp = 9,
		sEquipCmd_SendLeiTingStageUp = 10,
		sEquipCmd_SendLeiTingBaseInfo = 11,
		...
		sEquipCmd_ReqLeiTingLevelUp = 9,
		sEquipCmd_ReqLeiTingStageUp = 10,
	};
	...
	enum SkirmishCmd {
		...
		cField_EnterFuBen = 12,
		cField_ChangeAiState = 13, //切换玩家ai状态
		cField_GMMessage = 14, //玩家测试指令
		cField_GoldYBRelive = 15, //通知服务器元宝复活
		cField_ChaperEnterFuBen = 16,	//请求进入野外关卡副本
		cField_ExitChaperFuBen = 17,	//请求退出野外关卡副本到野外地图
		cField_GetAllEntityInfo = 18, //--客户端申请获取地图所有玩家和怪物信息
		cField_JumpPositionInfo = 19, //--客户端申请跳跃坐标
		sField_NoticePlayerDieInfo= 20, //通知客户端玩家死亡信息
		sField_NoticePlayerDropInfo = 21, //通知客户端玩家打怪掉落信息
		sField_NoticeFieldChaperInfo = 22, //通知客户端玩家副本关卡信息
		sField_NoticeFieldChaperAward = 23, //通知客户端玩家挑战成功奖励
		sField_NoticeChaperChallengeState = 24, //通知客户端玩家挑战关卡状态 0 挑战成功 1玩家死亡
		sField_UpdateAllEntityInfo = 25, //--向客户端下发地图玩家和怪物信息
		sField_SyncActorInfo = 26, //--同步玩家等级信息
		sField_SyncActorGuildInfo = 27, //--同步玩家行会信息
		sField_GetBossList = 28, //--获取野外地图boss列表
		sField_UpdateBelongInfo = 29, //--更新野外副本归属信息

		cField_EnterFieldToPoint = 30, //--进入副本指定的坐标点
		cField_ChangePkMode = 31, //--切换pk模式
		cField_GetBossList = 32, //--获取野外地图boss列表
		cField_GetChaperLevelList = 33, //--获取关卡战力列表

		sField_ChangePkMode = 40, //--回复客户端切换模式
		sField_UpdateHatredList = 41, //--更新伤害列表
		sField_GetChaperLevelList = 42, //--获取关卡战力列表
	...
	enum ActivityCmd {
		...
		cActivityCmd_FinishTask = 23, //客户端完成任务
	...
	enum PActivityCmd {
		...
		sPActivityCmd_NoticeOpenActivity = 8, // 通知开启活动
	...
	enum Tianti
	{
		...
		sTiantiCmd_ListData = 1, //返回匹配列表数据
		sTiantiCmd_RankListData = 2, //排行榜列表数据
		sTiantiCmd_ChallengesRecord = 3, //挑战记录数据
		sTiantiCmd_BuyCountReturn = 5, //购买挑战次数返回
		sTiantiCmd_UpdataChallengesData = 6, //同步挑战数据
		sTiantiCmd_ChallengesResult = 7, //同步挑战结果

		//C2S
		cTiantiCmd_RequesRefreshtList = 1, //请求刷新列表
		cTiantiCmd_RequestRankList = 2, //请求排行榜列表
	...
	enum KuangCmd
	{
		...
		sKuang_NoticeAttackInfo = 10, //通知掠夺和复仇结果
